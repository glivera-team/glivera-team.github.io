...
Далее собираем gulp-таски в один и отправлем его в default и watcher:
{% highlight javascript %}
...
Чтобы стайлгайд "ожил" необходмио в стилях прописать комментарии с помощью kss. Синтаксис kss подробно расписан на <a href="http://warpspire.com/kss/syntax/" target="_blank">их сайте</a>.
Выглядит это так:
